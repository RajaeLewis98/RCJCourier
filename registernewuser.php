				...
				<form action="register.php" method = "POST" name="registerform">
			        ...
			        if (isset($_POST['register'])) {
			            ...
			            //Confirm both passwords entered are the same
			                ...
			                $result   = mysqli_query($mysqli, "INSERT INTO users(id,firstname,lastname,email,password,regdate,usertype,token) VALUES('$id','$fname','$lname','$email','$hashpassword','$timestamp','$usertype','$token')");
